...
namespace phonebook
{
    public partial class phonebook : Form
    {
        ...
        {
            infodataGridView.DataSource = contacts.ToList();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!editing)
            {
                ...
                {
                    MessageBox.Show("لطفاً نام و شماره تلفن را وارد کنید.", "خطا", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
        ...
        {   
            ...
            id = Convert.ToInt32(infodataGridView.Rows[infodataGridView.CurrentRow.Index].Cells[0].Value);
       ...
       private void cleardatas()
        ...
        private void searchbutton_Click(object sender, EventArgs e)
        {
            ...
            infodataGridView.DataSource = filteredContacts;
        }
